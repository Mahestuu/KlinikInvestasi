    <nav
        ...
        <div class="container mx-auto flex items-center justify-between h-20 px-4 lg:px-6 xl:px-8 max-w-7xl">
            <!-- Brand Logo -->
            ...
            <div class="navbar-end items-center hidden lg:flex flex-nowrap gap-1.5 min-w-0">
                <ul class="menu menu-horizontal px-0 flex-nowrap gap-1.5 min-w-0">
                    <li class="flex-shrink-0">
                        <a href="{{ LaravelLocalization::getLocalizedURL(null, route('home')) }}"
                            class="flex justify-center items-center px-3 py-2 rounded-xl font-medium text-xs xl:text-sm text-gray-700 dark:text-gray-200 hover:text-white hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 transition-all duration-300 group relative overflow-hidden whitespace-nowrap">
                            <span class="text-base">{{ __('messages.home') }}</span>
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 rounded-lg">
                            </div>
                        </a>
                    </li>
                    <li class="flex-shrink-0">
                        <a href="{{ LaravelLocalization::getLocalizedURL(null, route('kbli.index')) }}"
                            class="flex justify-center items-center px-3 py-2 rounded-xl font-medium text-xs xl:text-sm text-gray-700 dark:text-gray-200 hover:text-white hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 transition-all duration-300 group relative overflow-hidden whitespace-nowrap">
                            <span class="text-base">{{ __('messages.business_requirements') }}</span>
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 rounded-lg">
                            </div>
                        </a>
                    ...
                    <li class="flex-shrink-0">
                        <a href="{{ LaravelLocalization::getLocalizedURL(null, route('pbumku.index')) }}"
                            class="flex justify-center items-center px-3 py-2 rounded-xl font-medium text-xs xl:text-sm text-gray-700 dark:text-gray-200 hover:text-white hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 transition-all duration-300 group relative overflow-hidden whitespace-nowrap">
                            <span class="text-base">{{ __('messages.pbumku_requirements') }}</span>
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 rounded-lg">
                            </div>
                        </a>
                ...
                <!-- Language Toggle -->
                <div class="dropdown dropdown-end language-dropdown flex-shrink-0 ml-1.5">
                    <div tabindex="0" role="button"
                        class="btn btn-ghost btn-circle hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-300 p-2">
                        <i class="fas fa-globe w-4 h-4 xl:w-5 xl:h-5"></i>
                    </div>
                    <ul tabindex="0"
                        class="dropdown-content menu bg-white dark:bg-gray-900 rounded-box z-50 mt-4 w-32 p-2 shadow">
                        <li><a href="{{ LaravelLocalization::getLocalizedURL('id', null, [], true) }}">Indonesia</a>
                        </li>
                ...
                <ul tabindex="0"
                    ...
                    <li class="border-t border-gray-200 dark:border-gray-700 pt-2 mt-2">
                        <div class="dropdown dropdown-end language-dropdown-mobile">
                            ...
                            <ul tabindex="0"
                                class="dropdown-content menu bg-white dark:bg-gray-900 rounded-box z-50 mt-2 w-56 p-2 shadow">
                                <li><a
                                        href="{{ LaravelLocalization::getLocalizedURL('id', null, [], true) }}">Indonesia</a>
                                </li>
                                <li><a
